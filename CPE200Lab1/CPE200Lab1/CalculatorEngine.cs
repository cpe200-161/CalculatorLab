...
namespace CPE200Lab1
{
    ...
    {
        public string calculate(string operate, string firstOperand, string secondOperand="0", string prev_operate="0")
        {
            int maxOutputSize = 8;
            ...
            switch (operate)
            {
                ...
                case "%":
                    //your code here
                    switch (prev_operate) //condition to check operator to calculate in percent case
                    {  
                        case "+":
