namespace CPE200Lab1
{
    partial class ExtendForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnPlus.Click += new System.EventHandler(this.thisOperator_Click);
			// 
			// btn3
			// 
			...
			this.btnMinus.Click += new System.EventHandler(this.thisOperator_Click);
			// 
			// btn6
			// 
			...
			this.btnMultiply.Click += new System.EventHandler(this.thisOperator_Click);
			// 
			// btn9
			// 
