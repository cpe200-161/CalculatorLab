namespace CPE200Lab1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btn7.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btn8
			// 
			...
			this.btn8.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btn9
			// 
			...
			this.btn9.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btnMultiply
			// 
			...
			this.btn6.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btn5
			// 
			...
			this.btn5.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btn4
			// 
			...
			this.btn4.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btnPlus
			// 
			...
			this.btn3.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btn2
			// 
			...
			this.btn2.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btn1
			// 
			...
			this.btn1.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btnEqual
			// 
			...
			this.btn0.Click += new System.EventHandler(this.btnNummber_Click);
			// 
			// btnSign
			// 
