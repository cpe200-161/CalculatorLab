...
namespace CPE200Lab1.Tests
{
    ...
    public class RPNCalculatorEngineTests
    {
        ...
        public void Process_Complex_Test()
        {
            ...
            Assert.AreEqual("14", r.calculate("5 1 2 + 4 X 3 - +"));
            Assert.AreEqual("-1", r.calculate("1 1 1 + -"));
            Assert.AreEqual("1", r.calculate("1 1 + 1 -"));
            //
            Assert.AreEqual("360", r.calculate("300 20 % +"));
        ...
        public void Process_Error_Test()
        {
            ...
            Assert.AreEqual("E", r.calculate("1 1 1 + + +"));
            //
            Assert.AreEqual("E", r.calculate("1 1 1 + 1 -"));
            Assert.AreEqual("E", r.calculate("1 0 ÷"));
        }
    }
}